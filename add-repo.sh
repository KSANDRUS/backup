...
DUPLICITY_GCD_TOKEN="../secrets/gcd-token.json" DUPLICITY_PASSWORD="$password" duplicacy init -e -repository "$tgt_path" phone gcd://d001 || die "Error initializing repository"
